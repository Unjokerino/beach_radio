...
export default function PlayerScreen({ navigation }) {
  ...
  const getStatus = async () => {
    ...
    setCurrentSong({
      title,
      author,
      cover: `https://myradio24.com/${status.img}`,
    });
    ...
    <View style={{ flex: 1 }}>
      <View style={[styles.centered]}>
        <ImageBackground
          ...
          resizeMode="cover"
          source={
            playing ? { uri: currentSong.cover } : require("../assets/logo.png")
          }
        ...
        >
          ...
          <View style={styles.songTitleContainer}>
            ...
            {currentSong.author && (
              <Text style={styles.subtitle}>{currentSong.author}</Text>
            )}
          </View>
            ...
            <View style={styles.playerContainer}>
              <DonutChart color="white" percentage={playing ? 100 : 0}>
                <View style={styles.player}>
                  {loading ? (
                    <ActivityIndicator size="large" color="#E8C754" />
                  ) : (
                    <IconButton
          ...
          <View style={styles.listenersContainer}>
            <IconButton icon="account-multiple" color="#fff" />
